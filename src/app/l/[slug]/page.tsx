...
import { cityPath, listingPath, serviceLabel, servicePath, typeLabel } from "@/lib/config";
import { listingJsonLd } from "@/lib/jsonld";
import { asStringArray, getListingBySlug, listingServices } from "@/lib/listings";
            ...
            <div className="mt-3 flex flex-wrap gap-2">
              {services.map((item) => (
                <Link
                  ...
                  className="rounded-full bg-concrete-light px-3 py-1 text-sm hover:bg-concrete"
                >
                  {serviceLabel(item)}
                </Link>
              ))}

    ...
    <main>
      ...
      <section className="relative overflow-hidden bg-slate text-page">
        ...
        <div className="relative mx-auto max-w-6xl px-5 py-24 md:py-32">
          ...
          <h1 className="mt-5 max-w-xl font-display text-5xl leading-none md:text-6xl">
            <span className="font-semibold text-page">BelowGrade</span>
            <span className="font-extrabold text-amber">Pros</span>
          </h1>
      ...
      <section className="mx-auto grid max-w-6xl gap-6 px-5 py-16 md:grid-cols-2">
        <div className="rounded-2xl bg-slate p-8 text-page">
          ...
          <p className="mt-4 text-sm leading-7 text-concrete/80">
            Browse a metro, filter foundation repair or encapsulation, then inquire directly. No
            marketplace take-rate. No booking engine.
          </p>
        ...
        <div className="rounded-2xl border border-slate/10 bg-white p-8">
          ...
          <p className="mt-4 text-sm leading-7 text-slate-soft">
            Claim an existing profile or submit a new one. Listings stay editorial — founding /
            featured is the paid upgrade.
          </p>
